...
CREATE TABLE IF NOT EXISTS TypeVoertuig( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, TypeVoertuig VARCHAR(200) NOT NULL, Rijbewijscategorie VARCHAR(10) NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL) ENGINE = InnoDB;
INSERT INTO
   TypeVoertuig 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS Instructeur( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Voornaam VARCHAR(200) NOT NULL, Tussenvoegsel VARCHAR(200), Achternaam VARCHAR(200) NOT NULL, Mobiel VARCHAR(11) NOT NULL, DatumInDienst DATE NOT NULL, AantalSterren VARCHAR(5), IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL) ENGINE = InnoDB;
INSERT INTO
   Instructeur 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS Voertuig( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Kenteken VARCHAR(8) NOT NULL, Type VARCHAR(50) NOT NULL, Bouwjaar DATE NOT NULL, Brandstof VARCHAR(10) NOT NULL, TypeVoertuigId INT NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL, FOREIGN KEY (TypeVoertuigId) REFERENCES TypeVoertuig(Id)) ENGINE = InnoDB;
INSERT INTO
   Voertuig 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS VoertuigInstructeur( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, VoertuigId INT NOT NULL, InstructeurId INT NOT NULL, DatumToekenning DATE NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL, FOREIGN KEY (VoertuigId) REFERENCES Voertuig(Id), FOREIGN KEY (InstructeurId) REFERENCES Instructeur(Id)) ENGINE = InnoDB;
INSERT INTO
   VoertuigInstructeur 
VALUES
   (
